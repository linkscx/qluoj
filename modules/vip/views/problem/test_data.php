    ...
    <div class="row table-responsive">
        ...
        <div class="col-md-6">
            <table class="table table-bordered table-rank">
                <caption>
                    标准输入文件
                    <a href="<?= Url::toRoute(['/vip/problem/deletefile', 'id' => $model->id,'name' => 'in']) ?>" onclick="return confirm('确定删除全部输入文件？');">
                        删除全部输入文件
                    </a>
                </caption>
                <tr>
                ...
                <?php foreach ($files as $file): ?>
                    ...
                    <tr>
                        ...
                        <th>
                            <a href="<?= Url::toRoute(['/vip/problem/viewfile', 'id' => $model->id,'name' => $file['name']]) ?>"
                               target="_blank"
                               title="<?= Yii::t('app', 'View') ?>">
                                <span class="glyphicon glyphicon-eye-open"></span>
                            </a>
                            &nbsp;
                            <a href="<?= Url::toRoute(['/vip/problem/deletefile', 'id' => $model->id,'name' => $file['name']]) ?>"
        ...
        <div class="col-md-6">
            <table class="table table-bordered table-rank">
                <caption>
                    标准输出文件
                    <a href="<?= Url::toRoute(['/vip/problem/deletefile', 'id' => $model->id, 'name' => 'out']) ?>" onclick="return confirm('确定删除全部输出文件？');">
                        删除全部输出文件
                    </a>
                </caption>
                <tr>
