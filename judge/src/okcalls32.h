 ...
 */
//c & c++
int LANG_CV[256] = { 85, 8,140,257, SYS_time, SYS_read, SYS_uname, SYS_write, SYS_open,
...
//php
int LANG_PHV[256] = {3,4,5,6,11,13,33,45,54,59,78,91,122,125,140,174,175,183,191,192,195,
