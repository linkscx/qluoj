 ...
 */
//c & c++
int LANG_CV[256] = {0,1,2,3,4,5,8,9,10,11,12,20,21,59,63,89,99,158,202,231,240,257,272,273,275,511, SYS_time, SYS_read, SYS_uname, SYS_write, SYS_open,
...
//python
int LANG_YV[256] = {1,0,2,3,4,5,9,10,11,12,13,14,17,21,32,56,59,89,97,99,102,104,107,108,131,157,158,202,218,228,231,273,257,318,
                61, 22, 6, 33, 8, 13, 16, 111, 110, 39, 79, 302, SYS_fcntl,
                SYS_getdents64, SYS_getrlimit, SYS_rt_sigprocmask, SYS_futex, SYS_read,
                SYS_mmap, SYS_stat, SYS_open, SYS_close, SYS_execve, SYS_access,
                SYS_brk, SYS_readlink, SYS_munmap, SYS_close, SYS_uname, SYS_clone,
